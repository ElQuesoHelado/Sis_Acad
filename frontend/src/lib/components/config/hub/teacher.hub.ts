...
import { Users, ClipboardCheck, BookOpenCheck, Calendar, CalendarPlus, CalendarDays, FileCheck, ListTodo } from '@lucide/svelte';
...
export const teacherHubGroups: HubGroup[] = [
  {
    ...
    items: [
      ...
      {
        title: 'Avance Silábico',
        description: 'Marcar temas completados según el sílabo.',
        url: '/dashboard/teacher/syllabus-progress',
        icon: ListTodo
      },
      {
    ...
    items: [
      {
        ...
        description: 'Subir evidencias, sílabos y estadísticas',
        url: '/dashboard/teacher/accreditation',
        icon: FileCheck,
      },
    ]
  }
