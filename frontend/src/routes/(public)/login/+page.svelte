...
<div
	class="flex min-h-[calc(100vh-9rem)] flex-col items-center justify-center bg-muted p-6 md:p-10"
>
	<div class="flex w-full max-w-sm flex-col gap-6">
		...
		{#if errorMessage}
			<div class="rounded-lg border border-destructive bg-destructive/10 p-3 text-center">
