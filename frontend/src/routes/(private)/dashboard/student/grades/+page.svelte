	...
	<div class="mx-auto max-w-7xl space-y-6">
		<div class="space-y-2">
			...
			<p class="text-muted-foreground">
				Consulta todas tus calificaciones y promedios del semestre por curso
			</p>
		</div>
			...
			<Card class="border-destructive/50 bg-destructive/5">
				<CardContent class="pt-6">
					<div class="flex items-start gap-3">
						...
						<div>
							<h3 class="mb-1 font-semibold text-destructive">Error al cargar las notas</h3>
			...
			{#if summaries.length === 0}
				<Card>
					<CardContent class="flex flex-col items-center justify-center py-12">
						...
						<h3 class="mb-2 text-lg font-semibold">No hay notas registradas</h3>
							...
							<CardContent class="space-y-3">
								<div>
									<table class="min-w-full">
										<thead>
											<tr>
												<th class="px-2 py-1 text-left text-xs font-semibold text-muted-foreground"
													>Tipo</th
												>
												<th
													class="px-2 py-1 text-center text-xs font-semibold text-muted-foreground"
													>Nota</th
												>
											</tr>
										</thead>
										<tbody>
											{#each summary.grades as grade}
												<tr>
													...
													<td class="px-2 py-1 text-center text-sm font-medium">
								...
								<div class="mt-2 flex items-center justify-between">
									...
									<span
										class="inline-flex items-center rounded-md border border-primary/20 bg-primary/10 px-2.5 py-1 text-xs font-semibold text-primary"
									>
								...
								<div class="flex items-center justify-between">
									...
									<span
										class="inline-flex items-center rounded-md px-2.5 py-1 text-xs font-semibold {statusColor(
											summary.status
										)}"
									>
										{summary.status}
				...
				<Card>
					<CardContent class="pt-6">
						<div class="flex flex-col items-center justify-around gap-6 sm:flex-row">
							...
							<div class="flex items-center gap-4">
								<div class="rounded-lg bg-green-200/40 p-3">
							...
							<div class="flex items-center gap-4">
								<div class="rounded-lg bg-red-200/40 p-3">
							...
							{#if inProgress > 0}
								...
								<div class="flex items-center gap-4">
									<div class="rounded-lg bg-blue-200/40 p-3">
